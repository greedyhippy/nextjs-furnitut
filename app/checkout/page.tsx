...
export default async function Checkout() {
    return (
        <>
            <header className="fixed max-w-7xl w-full px-10 top-4 left-1/2 -translate-x-1/2 z-10 flex items-center gap-8">
                <Link href="/">
            ...
            <main className="page max-w-6xl mx-auto min-h-screen">
                <CheckoutForm />
            </main>
        </>
    );
