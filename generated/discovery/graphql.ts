...
export type FetchItemShapeQuery = { __typename?: 'Query', search: { __typename?: 'SearchResults', hits: Array<{ __typename?: 'brand', id: string | null, name: string | null, path: string | null, shape: string | null } | { __typename?: 'category', id: string | null, name: string | null, path: string | null, shape: string | null } | { __typename?: 'landingPage', id: string | null, name: string | null, path: string | null, shape: string | null } | { __typename?: 'menuItem', id: string | null, name: string | null, path: string | null, shape: string | null } | { __typename?: 'product', id: string | null, name: string | null, path: string | null, shape: string | null } | { __typename?: 'story', id: string | null, name: string | null, path: string | null, shape: string | null } | null> | null } | null };
...
export type GlobalSearchQuery = { __typename?: 'Query', search: { __typename?: 'SearchResults', summary: { __typename?: 'SearchSummary', totalHits: number | null } | null, hits: Array<{ __typename?: 'brand', id: string | null, name: string | null, path: string | null } | { __typename?: 'category', id: string | null, name: string | null, path: string | null } | { __typename?: 'landingPage', id: string | null, name: string | null, path: string | null } | { __typename?: 'menuItem', id: string | null, name: string | null, path: string | null } | { __typename?: 'product', id: string | null, name: string | null, path: string | null, defaultVariant: { __typename?: 'ProductVariantForProduct', defaultPrice: number | null, firstImage: { __typename?: 'Image', variants: Array<{ __typename?: 'ImageVariant', url: string | null, height: number | null, width: number | null } | null> | null } | null } | null } | { __typename?: 'story', id: string | null, name: string | null, path: string | null } | null> | null } | null };
